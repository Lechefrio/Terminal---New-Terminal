...
export default function RaceVisual({ dashboard = {} }) {
  ...
  return (
    <div className={`race-visual race-visual-photo race-visual-${poster.theme} race-visual-${poster.id}`} aria-label={`${location} race visual`} role="img" style={{ backgroundImage: "url('/race-photos/canada.svg?v=1')" }}>
